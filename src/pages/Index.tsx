        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-7xl font-normal mb-4 tracking-tight text-left">
              ...
              <br />
              {/* FIX: Added whitespace-nowrap to prevent the line from breaking */}
            ...
            >
              Building secure, modern, and scalable web, mobile, and cloud-based
              solutions for startups, academic institutions, and growing
              businesses.{" "}
