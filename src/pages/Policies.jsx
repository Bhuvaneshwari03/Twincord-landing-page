      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-left">
          ...
          <section className="mb-16">
            <div className="text-black text-base md:text-lg leading-relaxed">
              <p className="mb-6">
                ...
                the use of Twincord Technologies Private Limited's Website,
              ...
              <BlueDotList>
                <span>
                  <span className="font-bold">Client, You, Your:</span> Refers
                  to you, the person logging on this website and compliant to
                ...
                <span>
                  <span className="font-bold">Party, Parties, Us:</span> Refers
          ...
          <section className="mb-16">
            ...
            <div className="text-black text-base md:text-lg leading-relaxed">
              <p>
                Unless otherwise stated, Twincord Technologies Private Limited
                and/or its licensors own the intellectual property rights for
                all material on <TwinCordSites />. All intellectual property
                rights are reserved. You may access this from <TwinCordSites />{" "}
                for your own personal use subjected to restrictions set in these
                terms and conditions.
              </p>
              <BlueDotList>
                <span>
                  Republish material from <TwinCordSites />
                </span>
                <span>
                  Sell, rent or sub-license material from <TwinCordSites />
                </span>
                <span>
                  Reproduce, duplicate or copy material from <TwinCordSites />
                </span>
                <span>
                  Redistribute content from <TwinCordSites />
                </span>
              </BlueDotList>
            </div>
            <div className="w-full border-b-2 border-dotted border-[#00bfff] mt-10 mb-2 opacity-30"></div>
          ...
          <Section title="User Comments">
            <p>
              ...
              Twincord Technologies Private Limited does not filter, edit,
              publish or review Comments prior to their presence on the website.
              Comments do not reflect the views and opinions of Twincord
              Technologies Private Limited, its agents and/or affiliates.
          ...
          <Section title="Hyperlinking to our Content">
            ...
            <p className="mt-2">
              ...
              to other Website information so long as the link is not in any way
          ...
          <Section title="Removal of links from our website">
            <p>
              ...
              or so or to respond to you directly. We do not ensure that the
